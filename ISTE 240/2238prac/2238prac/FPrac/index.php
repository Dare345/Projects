...
<body>
	<!-- 
		JS #1 make the h1 below change its text between 'ISTE-240 2238 Final' and 
		'I changed it!' when clicked 
	-->
  	<header><h1 id="click" onclick="toggle(this)">ISTE-240 2238 Final</h1></header>
	...
	<!-- 
		JS #2 make the image swap on rollover, swap back on rollout 
		(img.png to dsb.jpg on rollover, dsb.jpg to img.png on rollout) 
	-->
			<figure><img id="pic" onmouseover="picture()" onmouseout="picture2()" src="assets/img/img.png"/></figure>
	...
	-->
     		<div id="form" name="order">
				<form name="order" action="index.php" method="post" onsubmit="return validate();">
					<h3>Purchase:</h3>
					Name:<input type="input" name="name" id="n"/><br />
					Address:<input type="input" name="address" id="a"/><br />
					How Many:<input type="number" name="howMany" style="width:4em" id="h"/><br />
					<br />
