...
?>
	...
	<div id="container">
		...
		<form name="OrderForm" action="orderprocess.php"  onsubmit="return validateForm();" method="post">
			...
			<!-- List the options for the number of toppings on the pizza order -->
			<p> Select the number of toppings you want on your pizza:<br />
				<input type="radio" name ="topping" value = "0" id="none" checked="true"/><label for="none">No Extra Toppings<label><br/>
				<input type="radio" name ="topping" value = "1" id="one"/><label for="one">One Topping<label><br/>
				<input type="radio" name ="topping" value = "2"  id="two"/><label for="two">Two Toppings<label><br/>
